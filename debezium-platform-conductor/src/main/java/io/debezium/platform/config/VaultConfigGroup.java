...
public interface VaultConfigGroup {
     ...
     * <p>
     * Platform-wide, like the auth role: every vault a pipeline binds to lives in the same store.
     * What differs per vault — its name and the path it serves — is recorded on the vault itself.
     * </p>
     *
